...
- 🔄 **Сортировка**: По имени, дате создания, статусу или типу
- 📄 **PDF экспорт**: Генерация профессиональных PDF отчетов
- 💾 **Кэширование**: Сохранение данных в JSON файлы для быстрого доступа
- 🎨 **Современный UI**: Адаптивный интерфейс с Bootstrap

## Поддерживаемые ресурсы

- ✅ Проекты (Projects)
- ✅ Виртуальные машины (Servers)
- ✅ Диски (Volumes)
- ✅ Балансировщики нагрузки (Load Balancers)
- ✅ Плавающие IP (Floating IPs)
- ✅ VPN сервисы
- ✅ Kubernetes кластеры
- ✅ Роутеры (Routers)
...
3. **Сортировка** - Сортировка по различным полям
4. **Фильтрация** - Фильтр по типу ресурса
5. **Обновление данных** - Кнопка "Обновить данные" для получения свежей информации
6. **PDF экспорт** - Кнопка "Экспорт PDF" для скачивания отчета
...
- Для получения данных всех проектов нужны админские права
